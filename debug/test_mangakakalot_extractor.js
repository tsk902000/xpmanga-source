// Test script for MangaKakalot extractor
// Run with: node tests/test_mangakakalot_extractor.js
...
async function runTests() {
  console.log('=== MangaKakalot Extractor Test ===');
  console.log(`Extractor version: ${extractor.version}`);
  console.log(`Base URL: ${extractor.baseUrl}`);

  // Test URLs
  const testListUrl = 'https://www.mangakakalot.gg/manga-list/latest-manga';
  const testMangaUrl = 'https://www.mangakakalot.gg/manga/the-war-of-corpses/';
  const testChapterUrl = 'https://www.mangakakalot.gg/manga/the-war-of-corpses/chapter-7';
  ...
  const resultsPath = path.join(__dirname, 'mangakakalot_test_results.json');
